        ...
        >
          ...
          {Array.from({ length: 13 }).map((_, i) => {
            ...
            return (
              <g key={`lon-${i}`}>
                ...
                />
                <text x={x + 2} y={H - 4} fill="#5a6a7a" fontSize="8" fontFamily="IBM Plex Mono">
                  {lon}°
                </text>
              </g>
            );
          ...
          {Array.from({ length: 7 }).map((_, i) => {
            ...
            return (
              <g key={`lat-${i}`}>
                ...
                />
                <text x={2} y={y - 2} fill="#5a6a7a" fontSize="8" fontFamily="IBM Plex Mono">
                  {lat}°
                </text>
              </g>
            );
          ...
          {points.map((p) => (
            <circle
              ...
              cx={p.x}
              cy={p.y}
              r={p.id === selectedId ? 4 : 1.5}
              fill={p.id === selectedId ? "var(--primary)" : "#2a3a4a"}
            />
          ))}
          {sel && (
            <g>
